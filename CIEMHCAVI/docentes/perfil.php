...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript" src="../js/modificarPerson.js"></script>
		<script src="../js/maskedinput.js" type="text/javascript"></script>
		<script src="../js/mask.js" type="text/javascript"></script>
		<script type="text/javascript" src="../js/perfilDocente.js"></script>
		<script type="text/javascript" src="../js/deleteDocente.js"></script>
	</head>
	<body>
		<?php
		...
		echo '<div class="page" >
			...
			<div class="content">
				...
				<fieldset id="user_info">
					...
					<form id="modificarPerson" class="formConfirm" action="../queries/modificarDocente.php" method="post" enctype="multipart/form-data">
					<br />
					<img id="img_doc"  height="88px"/>
					<table id="perfil">
							<tr>
								<td align="right">Nombre Completo:</td>
								<td>
								<input type="text" size="18" placeholder="Nombre" required="required" id="nombre" class="ID" name="nombre">
							...
							<tr>
								...
								<td>
								<input type="radio" name="genero" value="masculino" required="required" checked="checked">
								Masculino
								<br />
							...
							<tr>
								...
								<td>
								<input type="tel" id="tel" name="telf">
								</td>
							</tr>
							<tr><td><br /></td></tr>
							<tr>
						...
						if($_SESSION['AllowADD']==1){
							echo '<input class="submitB" type="button" value="Modificar" id="modificar"/>
