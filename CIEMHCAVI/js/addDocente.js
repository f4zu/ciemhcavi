$(document).ready(function(){//jquery para mandar x post todo esta bien aqui
	...
	$("#addPerson").submit(function(event){
		...
		var telf=$("#telf").val();
		var foto=$("#foto").attr();
		$.post("../queries/addDocente.php",{nombre:nombre, ape1:ape1, ape2:ape2, ced:ced, pass:pass, email:email, genero:genero, fecha:fecha, nac:nac, direccion:direccion, telf:telf},function(result){
			if(result=="Confirmed"){
