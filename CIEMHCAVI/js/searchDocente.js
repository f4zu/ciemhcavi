$(document).ready(function() {
	...
	$("#nombre").keyup(function(event){
		...
		$.post("../queries/searchDocente.php",{nombre:nombre, ape1:ape1, ape2:ape2, cedula:cedula},function(result){
			if(i==2)
			{
				$("#searchTable").remove();
				i=1;
				$("#tableResults").html("<table id='searchTable' class='results' width='100%'><tr><th>Nombre</th><th>Primer Apellido</th><th>Segundo Apellido</th><th>Cédula</th><th>Correo</th><th>Teléfono</th></tr></table>");
			}
