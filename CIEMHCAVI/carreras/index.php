...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript" src="../js/searchCarrera.js"></script>
	</head>
	<body>
		<?php
		...
		<div class="page" >
			<div class="header">
				...
				<div id="nav">
					<table>
						...
						<th id="actual"><a href="#">Carreras</a></th>
			...
			<div class="content">
					...
					<form>
						...
						<table width="100%">
							<tr>
								...
								<td align="left">
								<input type="text" size="65" id="nombre"/>
								</td>
				...
				<table id="searchTable" class="results" width="100%"><tr><th>Nombre</th><th>Código</th></tr>
				</table>
			</div>
			<br />
		</div>';
