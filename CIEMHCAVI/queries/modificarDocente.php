...
if($conn!=null){// verifica campos requeridos en caso de error en conexion
	...
	isset($_POST['genero']) && !empty($_POST['genero']))
	{
		...
		if(!empty($_FILES['photo']['name']))
		{
			...
			@mysqli_stmt_bind_param($stmt, 'sssssssssss',$_POST['nombre'],$_POST['ape1'],$_POST['ape2'],$_POST['nac'],$_POST['telf'],$direccion,$_POST['email'],$nueva_fecha,$_POST['genero'],$_POST['ced'],$file_name);
