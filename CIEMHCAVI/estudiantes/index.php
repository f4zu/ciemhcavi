...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript" src="../js/searchEstu.js"></script>
	...
	<body>
		...
		<div class="page" >
			<div class="header">
				...
				<div id="nav">
					<table>
						...
						<th id="actual"><a href="#">Estudiantes</a></th>
			...
			<div class="content">
				...
				<table id="searchTable" class="results" width="100%"><tr><th>Nombre</th><th>Primer Apellido</th><th>Segundo Apellido</th><th>Cédula</th><th>Correo</th><th>Carnet</th></tr>
				</table>
			</div>
			<br />
		</div>';
