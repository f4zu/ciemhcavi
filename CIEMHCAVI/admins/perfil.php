...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript" src="../js/deleteAdmin.js"></script>
	</head>
	<body>
		<?php
		if(isset($_SESSION['userID'])&& !empty($_SESSION['userID'])){
			...
			<div class="content">
				...
				<fieldset id="user_info">
					...
					<form id="modificarPerson" class="formConfirm" action="../queries/modificarAdministrativo.php" method="post" enctype="multipart/form-data">
					<br />
					<img id="img_admin"  height="88px"/>
					<table id="perfil">
							<tr>
							...
							<tr>
								...
								<td>
								<input type="text" size="35" id="puesto" name="puesto">
								</td>
							</tr>
							<tr><td><br /></td></tr>
							<tr>
