		...
		if(isset($_SESSION['userID'])&& !empty($_SESSION['userID'])){
			...
			<div class="content">
				...
				<fieldset>
					...
					<br />
					<p>
						Favor de llenar <strong>todos</strong> los campos marcados con un <strong>*</strong> que denotan la <strong>información mínima requerida</strong> para agregar un nuevo administrativo.
					</p>
					<br />
					<form id="addPerson" class="formConfirm" action="../queries/addAdministrativo.php" method="post" enctype="multipart/form-data">
						<table>
							<tr>
